...
function deb_obs () {
    ...
    local deb9="Debian_9.0 Raspbian_9.0 xUbuntu_16.04 xUbuntu_17.10 xUbuntu_18.04  xUbuntu_18.10 xUbuntu_19.04 Ubuntu_Next_standard Debian_10 Debian_Next_ga"
