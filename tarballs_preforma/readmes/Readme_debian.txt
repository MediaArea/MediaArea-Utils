...
Download and unzip the buildenv17*.zip. Enter the directory
corresponding to your architecture, and type :
...
Download and unzip the src17*.zip. Enter the new directory created.
