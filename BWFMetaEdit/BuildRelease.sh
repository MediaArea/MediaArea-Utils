...
function _windows () {
    ...
    $SSHP "# Get password for signing
           ...
           If ((Test-Path \"Win32\\Release\\bwfmetaedit.exe\") -And (Test-Path \"x64\\Release\\bwfmetaedit.exe\")) {
               # Sign binaries
               cmd /s /c \"call \`\"C:\\Program Files (x86)\\Microsoft Visual Studio 14.0\\VC\\vcvarsall.bat\`\" && signtool sign /f %USERPROFILE%\\CodeSigningCertificate.p12 /p \$CodeSigningCertificatePass /fd sha256 /v /tr http://timestamp.geotrust.com/tsa /d BWFMetaEdit /du http://mediaarea.net \`\"Win32\\Release\\bwfmetaedit.exe\`\" \`\"x64\\Release\\bwfmetaedit.exe\`\"\"
           ...
           If ((Test-Path \"Win32\\Release\\BWF_MetaEdit_GUI.exe\") -And (Test-Path \"x64\\Release\\BWF_MetaEdit_GUI.exe\")) {
               # Sign binaries
               cmd /s /c \"call \`\"C:\\Program Files (x86)\\Microsoft Visual Studio 14.0\\VC\\vcvarsall.bat\`\" && signtool sign /f %USERPROFILE%\\CodeSigningCertificate.p12 /p \$CodeSigningCertificatePass /fd sha256 /v /tr http://timestamp.geotrust.com/tsa /d BWFMetaEdit /du http://mediaarea.net \`\"Win32\\Release\\BWF_MetaEdit_GUI.exe\`\" \`\"x64\\Release\\BWF_MetaEdit_GUI.exe\`\"\"
               ...
               # Sign installers
               cmd /s /c \"call \`\"C:\\Program Files (x86)\\Microsoft Visual Studio 14.0\\VC\\vcvarsall.bat\`\" && signtool sign /f %USERPROFILE%\\CodeSigningCertificate.p12 /p \$CodeSigningCertificatePass /fd sha256 /v /tr http://timestamp.geotrust.com/tsa /d DVAnalyzer /du http://mediaarea.net \`\"BWF_MetaEdit_GUI_${Version_new}_Windows_i386.exe\`\" \`\"BWF_MetaEdit_GUI_${Version_new}_Windows_x64.exe\`\"\"
           }"
    sleep 3
