...
function btask.UpgradeVersion.run () {
    ...
    updateFile "%define mediainfo_version_major\(\s\+\)$Version_old_major" \
        "%define mediainfo_version_major\1$Version_new_major" \
        "${MI_source}/Project/GNU/mediainfo.spec"
    updateFile "%define mediainfo_version_minor\(\s\+\)$Version_old_minor" \
        "%define mediainfo_version_minor\1$Version_new_minor" \
        "${MI_source}/Project/GNU/mediainfo.spec"
    ...
    if [ $(b.opt.get_opt --mil-version) ]; then
        ...
        updateFile "%define libmediainfo_version_major\(\s\+\)[0-9]\+" "%define libmediainfo_version_major\1${MIL_version_array[0]:-0}" "${MI_source}/Project/GNU/mediainfo.spec"
        updateFile "%define libmediainfo_version_minor\(\s\+\)[0-9]\+" "%define libmediainfo_version_minor\1${MIL_version_array[1]:-0}" "${MI_source}/Project/GNU/mediainfo.spec"
    ...
    if [ $(b.opt.get_opt --zl-version) ]; then
        ...
        updateFile "%define libzen_version_major\(\s\+\)[0-9]\+" "%define libzen_version_major\1${ZL_version_array[0]:-0}" "${MI_source}/Project/GNU/mediainfo.spec"
        updateFile "%define libzen_version_minor\(\s\+\)[0-9]\+" "%define libzen_version_minor\1${ZL_version_array[1]:-0}" "${MI_source}/Project/GNU/mediainfo.spec"
        updateFile "%define libzen_version_release\(\s\+\)[0-9]\+" "%define libzen_version_release\1${ZL_version_array[2]:-0}" "${MI_source}/Project/GNU/mediainfo.spec"
